 ...
 * @link https://raw.githubusercontent.com/Sylius/Sylius/master/src/Sylius/Bundle/ResourceBundle/Doctrine/ORM/EntityRepository.php
 */
abstract class AbstractRepository extends BaseEntityRepository
{
     ...
     * {@inheritdoc}
     */
    public function add(object $resource): void
    {
     ...
     * {@inheritdoc}
     */
    public function remove(object $resource): void
    {
